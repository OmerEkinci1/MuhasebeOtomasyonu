...
Additional information: Error converting data type varchar to datetime.
        ...
        */
        ...
        public DataTable Listele(string CariKodu, string CariAdi, string FaturaNo)
        {
            ...
            string sql = "SELECT * FROM VWFATURALAR where CARIKODU LIKE '%" + CariKodu + "%' AND CARIISIM LIKE '%" + CariAdi + "%' AND FATURANO LIKE '%" + FaturaNo + "%' AND TIPI='SI'";//SATIŞ İADE OLCAK
